...
def run_startup_eval_agent(state: StartupEvalState) -> StartupEvalState:
    ...
    schema_example = json.dumps({
        ...
        "tractionScore": 8,
        "finalScore": 7,
        "scoringReason": "팀 역량(창업자 경력·학력·엑싯 경험), 투자 현황(누적 투자금·투자자 신뢰도), 트랙션(매출 성장률·고객사 규모)을 각각 분석한 상세 근거 (5문장 이상)",
    ...
    system_msg = {
        ...
        "content": (
            ...
            "웹 검색을 통해 팀 역량, 투자 현황, 트랙션을 검증하고 "
            "종합적으로 평가하여 최종 점수를 산출합니다. "
